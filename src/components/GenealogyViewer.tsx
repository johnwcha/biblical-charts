...
const compactPositions: Record<string, { x: number; y: number; sourcePosition?: 'top' | 'right' | 'bottom' | 'left'; targetPosition?: 'top' | 'right' | 'bottom' | 'left' }> = {
  ...
  noah: { x: 80, y: 284, sourcePosition: 'bottom', targetPosition: 'right' },
  shem: { x: -40, y: 438, sourcePosition: 'bottom', targetPosition: 'top' },
  ham: { x: 270, y: 438, sourcePosition: 'bottom', targetPosition: 'top' },
  japheth: { x: 650, y: 438, sourcePosition: 'bottom', targetPosition: 'top' },
  arpachshad: { x: -220, y: 568, sourcePosition: 'bottom', targetPosition: 'top' },
  lud: { x: -80, y: 568, sourcePosition: 'bottom', targetPosition: 'top' },
  aram: { x: 60, y: 568, sourcePosition: 'bottom', targetPosition: 'top' },
  cush: { x: 200, y: 568, sourcePosition: 'bottom', targetPosition: 'top' },
  mizraim: { x: 340, y: 568, sourcePosition: 'bottom', targetPosition: 'top' },
  put: { x: 480, y: 568, sourcePosition: 'bottom', targetPosition: 'top' },
  canaan: { x: 620, y: 568, sourcePosition: 'bottom', targetPosition: 'top' },
  gomer: { x: 780, y: 568, sourcePosition: 'bottom', targetPosition: 'top' },
  magog: { x: 920, y: 568, sourcePosition: 'bottom', targetPosition: 'top' },
  madai: { x: 1060, y: 568, sourcePosition: 'bottom', targetPosition: 'top' },
  javan: { x: 1200, y: 568, sourcePosition: 'bottom', targetPosition: 'top' },
  tubal: { x: 1340, y: 568, sourcePosition: 'bottom', targetPosition: 'top' },
  shelah: { x: -205, y: 692, sourcePosition: 'right', targetPosition: 'top' },
  eber: { x: -60, y: 692, sourcePosition: 'right', targetPosition: 'left' },
  peleg: { x: 95, y: 692, sourcePosition: 'right', targetPosition: 'left' },
  reu: { x: 235, y: 692, sourcePosition: 'right', targetPosition: 'left' },
  serug: { x: 375, y: 692, sourcePosition: 'right', targetPosition: 'left' },
  nahor: { x: 525, y: 692, sourcePosition: 'right', targetPosition: 'left' },
  terah: { x: 675, y: 692, sourcePosition: 'bottom', targetPosition: 'left' },
};
